...
export default function TrigonometryRadians() {
    const angleAnchor = useMovablePoint(
        [Math.cos(START_ANGLE) * 3 * CIRCLE_RADIUS, Math.sin(START_ANGLE) * 3 * CIRCLE_RADIUS],
        {
            constrain: (point) =>
                vec.withMag(
                    [point[0] * 3 * CIRCLE_RADIUS, point[1] * 3 * CIRCLE_RADIUS],
                    3 * CIRCLE_RADIUS,
                ),
        },
    );
        ...
        <Slide>
            ...
            <div className="r-stretch">
                <Mafs height={700} viewBox={{ x: [-3, 12], y: [-3, 4] }}>
                    ...
                    <Circle center={[0, 0]} radius={3 * CIRCLE_RADIUS} />
                    <Line.Segment
                        point1={[0, 0]}
                        point2={[3 * CIRCLE_RADIUS, 0]}
                        color={Theme.pink}
                    />
                    ...
                    <Plot.Parametric
                        domain={[0, angleRad]}
                        xy={(t) => [
                            Math.cos(t) * ANGLE_ARC_DIST * CIRCLE_RADIUS,
                            Math.sin(t) * ANGLE_ARC_DIST * CIRCLE_RADIUS,
                        ]}
                        color={Theme.pink}
                        weight={3}
                    />
                    ...
                    <g style={{ fontSize: '0.7em' }}>
                        ...
                        <LaTeX tex={String.raw`b`} at={[2.3, 0.6]} color={Theme.green} />
                    </g>
                    ...
                    />
                    <g style={{ fontSize: '0.7em' }}>
                        <LaTeX tex={String.raw`r=1`} at={[1.5, -0.4]} color={Theme.foreground} />
                    </g>
